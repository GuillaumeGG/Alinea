...
int main(int argc, char **argv)
{
  ...
  setEvt(&evnt, varNewFunction(f_det), "determinant");
  setEvt(&evnt, varNewFunction(f_mult), "mult");
  setEvt(&evnt, varNewFunction(f_multScal), "mult_scal");
  setEvt(&evnt, varNewFunction(f_pow), "expo");
  setEvt(&evnt, varNewFunction(f_invert), "invert");
  setEvt(&evnt, varNewFunction(f_solve), "solve");
  setEvt(&evnt, varNewFunction(f_valP), "valP");
